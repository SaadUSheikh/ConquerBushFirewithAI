...
url = "https://gateway.api.epa.vic.gov.au/environmentMonitoring/v1/notices?environmentalSegment=air"
...
if response.status_code == 200:
    ...
    file_path = r'C:/Users/Owner/Downloads/output_querynotice.json'
